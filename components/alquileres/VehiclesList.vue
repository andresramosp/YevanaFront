    ...
    <section class="mainContentSection packagesSection">
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <!--LISTA DE VEHÍCULOS-->
            <div style="text-align: justify; margin-bottom: 25px">Nuestra flota cuenta con las mejores furgonetas campers de alquiler de Madrid. Camperizaciones únicas en diseño, calidad y equipamiento. Todas nuestras campers cuentan con placa solar, calefacción estacionaria y ducha. Nuestra gama dispone de una gran variedad de tamaños, accesorios y extras para configurar todo tipo de experiencias. Tanto si te gusta el entorno rural como la naturaleza más indómita, o eres un fan de los festivales, aquí encontrarás tu campervan perfecta. Y al regreso, si te has enamorado de nuestra camper, siempre podrás hacerla tuya... <span v-show="!$device.isMobile"> Y al regreso, si te has enamorado de nuestra camper, siempre podrás hacerla tuya... </span></div> 
